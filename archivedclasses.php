...
$users = "SELECT *
FROM
classes  WHERE facebook_id='".$_SESSION["strFacebookID"]."' AND archivedclass = 1"   ;//
...
LEFT JOIN users ON students_in_class.facebook_id = users.facebook_id
 WHERE students_in_class.facebook_id = '".$_SESSION["strFacebookID"]."'  AND students_in_class.archivedclass =1"  ;//
...
$i =0;if($num_rows_users > '0'){ ?> 
                                ...
                                <div class="actions actions--inverse">
                                    <div class="actions__item">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="uparchivedclasses.php?classid=<?php echo $array_users['class_id']; ?> ?>&archivedclass=0" ">Move</a>
 ...
 <div class="card card-inverse widget-profile col-md-12">
                 ...
                 <?php }
                    ...
                    <div class="card card-inverse widget-profile col-md-4">
                            <div class="card-header">
                            <a href="stream.php?classid=<?php echo $array_students['class_id']; ?>&cstudents_id=0">
                                    ...
                                    <div class="actions__item">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="detjoinclass.php?classid=<?php echo $array_students['class_id']; ?>&cstudents_id=<?php echo $array_students['student_in_class_id']; ?>" data-demo-action="delete-listing" onclick="return confirm('ยืนยันการลบ')">Delete</a>
                                             <a class="dropdown-item" href="uparchivedclassstudents.php?classid=<?php echo $array_students['class_id']; ?>&facebook_id=<?php echo $array_students['facebook_id']; ?>&archivedclass=0" ">Move</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
